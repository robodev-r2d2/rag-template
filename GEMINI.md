# GEMINI.md
> **Scope:** These instructions tune our **Gemini** code-generation agent (LLM via API/CLI) for this monorepo. They are **authoritative**: follow them over generic best practices. Output must compile, pass linters/tests, and fit our structure.
...
## 9) Examples the agent should imitate
...
## 12) Quick checklist (for every suggestion)
