...
| mlflow_manager | [`rag_core_lib.impl.mlflow_manager.mlflow_manager.MlflowManager`](./rag-core-lib/src/rag_core_lib/impl/mlflow_manager/mlflow_manager.py) | [`rag_core_lib.impl.mlflow_manager.mlflow_manager.MlflowManager`](./rag-core-lib/src/rag_core_lib/impl/mlflow_manager/mlflow_manager.py) | Logs prompts to MLflow and returns managed prompts/LLMs. |
...
| traced_chat_graph | [`rag_core_lib.runnables.AsyncRunnable[Any, Any]`](./rag-core-lib/src/rag_core_lib/runnables/async_runnable.py) | [`rag_core_lib.impl.tracers.mlflow_traced_runnable.MlflowTracedRunnable`](./rag-core-lib/src/rag_core_lib/impl/tracers/mlflow_traced_runnable.py) | Wraps around the *chat_graph* and adds MLflow tracing. |
| evaluator | [`rag_core_api.impl.evaluator.mlflow_ragas_evaluator.MlflowRagasEvaluator`](./rag-core-api/src/rag_core_api/impl/evaluator/mlflow_ragas_evaluator.py) | [`rag_core_api.impl.evaluator.mlflow_ragas_evaluator.MlflowRagasEvaluator`](./rag-core-api/src/rag_core_api/impl/evaluator/mlflow_ragas_evaluator.py) | The evaluator used in the evaluate endpoint. |
...
- tracing for `LangChain` chains using `MLflow`
- settings for multiple LLMs and MLflow
- factory for LLMs
