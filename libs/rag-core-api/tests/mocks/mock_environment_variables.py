...
def mock_environment_variables() -> None:
    ...
    os.environ["KEYCLOAK_ENFORCE"] = "false"
    os.environ["KEYCLOAK_SERVER_URL"] = "http://localhost:8080"
    os.environ["KEYCLOAK_REALM"] = "test"
    os.environ["KEYCLOAK_INTROSPECTION_CLIENT_ID"] = "test"
    os.environ["KEYCLOAK_INTROSPECTION_CLIENT_SECRET"] = "test"
    os.environ["ACCESS_CONTROL_DEFAULT_GROUP"] = "public"
    os.environ["ACCESS_CONTROL_METADATA_KEY"] = "access_groups"
